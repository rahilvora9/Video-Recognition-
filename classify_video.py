...
def run_inference_on_image(image):
  ...
  with tf.Session() as sess:
    ...
    #   encoding of the image.https://www.jetbrains.com/pycharm/download/download-thanks.html?platform=linux
    ...
    for node_id in top_k:
      ...
      if human_string=="assault rifle, assault gun" or human_string=="rifle" or human_string=="revolver, six-gun, six-shooter" or human_string=="projectile, missile":
        print('%s (score = %.5f)' % (human_string, score))


def maybe_download_and_extract():
  """Download and extract model tar file."""
  dest_directory = FLAGS.model_dirclassify_image
